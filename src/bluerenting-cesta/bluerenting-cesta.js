    ...
    render() {
        ...
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-BmbxuPwQa2lc/FVzBcNJ7UAyJxM6wuqIj61tLrc4wSX0szH/Ev+nYRRuWlolflfl" crossorigin="anonymous">
            <div class="card h-10 w-65 card text-center">
                <img src="${this.imageUrl}" height="180" width="250" ></img>    
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Coche ${this.name} </li>
                        <li class="list-group-item">${this.price} euros/mes</li>
                    </ul>
                </div>            
                <div class="card-footer">
                    <button @click="${this.deleteCoche}" class="btn btn-danger me-md-2 col-2 "><strong>X</strong></button>
                </div>
            </div>
